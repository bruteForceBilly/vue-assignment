<template>
  <div class="w-sceen h-screen flex flex-col items-center pt-40">
    <svg
      version="1.1"
    ...
    <h1 class="text-5xl ml-16 mt-16 mb-2">
      FleetManager <span class="text-sm align-top font-thin">Alpha 0.1</span>
    </h1>
    <p>
      Tecnical assigment made by
      <a
        href="https://github.com/bruteForceBilly"
        class="underline visited:text-gray-400"
        >bruteForceBilly</a
      >
    </p>
  </div>
